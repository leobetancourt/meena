...
if __name__ == "__main__":
    ...
    # sim = Sim_2D(gamma=1.4, resolution=(200, 200), xrange=(0, 1), yrange=(0, 1))
    # sim.quadrants()
    # sim.run(T=1, var="density", filename="quadrants")
    ...
    sim.run(T=2, var="density", filename="KH")
    ...
    # sim.rayleigh_taylor()
    # sim.run(T=15, var="density", filename="RT")
